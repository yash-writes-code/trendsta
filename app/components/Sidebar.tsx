...
import { Home, Play, Hash, Sparkles, User, TrendingUp, Users, FileText, ChevronLeft, ChevronRight } from "lucide-react";
    ...
    return (
        ...
        >
            ...
            <div className="p-4 border-t border-slate-200">
                <div className={`flex items-center gap-3 p-2 rounded-xl hover:bg-slate-50 cursor-pointer transition-all duration-200 ${isCollapsed ? "justify-center" : ""}`}>
                    <div className="w-9 h-9 rounded-full bg-slate-100 flex items-center justify-center text-slate-600 shrink-0">
                        <User size={18} />
                    </div>
                    {!isCollapsed && (
                        <div className="flex-1 overflow-hidden">
                            <p className="text-sm font-semibold text-slate-900 truncate">Creator Pro</p>
