...
import { CompetitorResearch, ReelData } from "@/app/types/trendsta";
...
export default function CompetitorsClient({ data }: CompetitorsClientProps) {
    ...
    const competitorsList = useMemo(() => {
        ...
        const list = Array.from(map.values()).map(comp => {
            ...
            // engagement rate avg?
            // Assuming engagement_rate on reel is percentage e.g. 0.05 or 5.
